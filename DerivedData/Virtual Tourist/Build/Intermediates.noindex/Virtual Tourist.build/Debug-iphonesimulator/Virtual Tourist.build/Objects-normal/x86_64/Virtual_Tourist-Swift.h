...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Virtual_Tourist",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15Virtual_Tourist12FlickrObject")
...
SWIFT_CLASS("_TtC15Virtual_Tourist15FlickrPhotoCell")
...
- (IBAction)dropPinWithSender:(UILongPressGestureRecognizer * _Nonnull)sender;
- (IBAction)clearPins:(id _Nonnull)sender;
...
@interface PhotoAlbumViewController : UIViewController <NSFetchedResultsControllerDelegate, MKMapViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
@property (nonatomic, weak) IBOutlet MKMapView * _Null_unspecified mapView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified noImagesLabel;
@property (nonatomic, weak) IBOutlet UIBarButtonItem * _Null_unspecified newCollectionButton;
@property (nonatomic, weak) IBOutlet UICollectionView * _Null_unspecified imageCollectionView;
- (void)viewDidLoad;
- (void)viewDidDisappear:(BOOL)animated;
- (IBAction)pullNewPhotoCollection:(id _Nonnull)sender;
